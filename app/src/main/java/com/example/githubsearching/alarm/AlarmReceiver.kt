package com.example.githubsearching.alarm
...
import com.example.githubsearching.activity.MainActivity
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        showAlarmNotification(context, "Github App Reminder", message!!, notifId)
